...
#'
#' @return 
#'   a data.table that includes class 'measures' with an optional key set.
#'   
#' @examples
#'   measures( iris, key='Species' ) 
#'   measures( mtcars, "cyl" )     
#' @export   

measures <- function(data, key=NULL, index=NULL ) {
  
  setDT(data)  
  class(data) <- c( 'measures', 'features', class(data) )
